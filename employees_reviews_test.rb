...
class EmployeesReviewsTest < Minitest::Test
  ...
  def test_13_regex_to_determine_satisfactory_rating
    e = Employee.new(employee_name: "Greg", employee_email_address: "Greg@yahoo.com",
    employee_phone_number: "7179991111", employee_salary: 80000.00,
    employee_satisfaction:(), employee_review: "Greg is a very positive person
    ...
    f = Employee.new(employee_name: "Richard", employee_email_address: "Greg@yahoo.com",
    employee_phone_number: "7179991111", employee_salary: 90000.00, employee_satisfaction:(),
    ...
    g = Employee.new(employee_name: "Danny", employee_email_address: "Greg@yahoo.com",
    employee_phone_number: "7179991111", employee_salary: 60000.00, employee_satisfaction:(),
    ...
    employee_satisfaction:(), employee_review: "Molly has been an incredibly consistent
    ...
    e.emp_comp_assessment
    f.emp_comp_assessment
    g.emp_comp_assessment
    h.emp_comp_assessment
    refute true, e.employee_satisfaction
    refute true, f.employee_satisfaction
    assert true, g.employee_satisfaction
    assert true, h.employee_satisfaction
